...
| `oci.core.VirtualNetworkClient` | `list_virtual_circuit_bandwidth_shapes` | 사용 가능한 bandwidth shape 목록 수집 | 현재/가능 bandwidth 옵션 확인에 필요 | `fastconnect_enriched.bandwidth_shapes[]` | region + compartment | compartment 수에 비례 |
